...
import { RoutePermissionResolver } from '../permissions/route-permission.resolver.js';
...
export class ApiAuthorizationGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    if (!surface && this.isProtectedApiController(context)) {
  ...
  private isProtectedApiController(context: ExecutionContext): boolean {
