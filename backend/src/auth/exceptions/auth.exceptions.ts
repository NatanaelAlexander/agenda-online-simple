...
export class BookingSessionInvalidaException extends AppException {
  constructor() {
    super('Sesión de reserva inválida o expirada', HttpStatus.UNAUTHORIZED);
  }
}

export class BookingSessionUsadaException extends AppException {
  constructor() {
    super(
      'Esta sesión de reserva ya se usó. Vuelve a iniciar con Google.',
      HttpStatus.UNAUTHORIZED,
    );
  }
}

export class CodigoResetInvalidoException extends AppException {
  constructor() {
    super('Código de recuperación inválido o expirado', HttpStatus.BAD_REQUEST);
  }
}
